...
import '../../../profile/screens/success_user_profile_screen.dart';
import '../../controllers/TeamCreateController.dart';
import '../../models/team_model.dart';

class TeamAddressFormWidget extends ConsumerStatefulWidget {
  final goNextPage;
  final goPrevPage;
  final done;

  const TeamAddressFormWidget({
  ...
  @override
  ConsumerState<TeamAddressFormWidget> createState() =>
      _AddressFormWidgetState();
}

class _AddressFormWidgetState extends ConsumerState<TeamAddressFormWidget> {
  ...
  void initState() {
    ...
    address_code = teamModel.addressCode;
    addressEditController = TextEditingController(text: teamModel.addressName);
  }
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Expanded(
              flex: 1,
              child: Text('${teamModel.name}님 활동 지역은 어디신가요?',
                  textAlign: TextAlign.left,
                  style: AppTextStyles.headlineTextStyle),
            ),
            Expanded(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        try {
                          TeamModel updatedTeam = await ref
